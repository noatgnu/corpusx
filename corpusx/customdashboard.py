...
And to activate the app index dashboard::
    ADMIN_TOOLS_APP_INDEX_DASHBOARD = 'corpusx.customdashboard.CustomAppIndexDashboard'
"""
...
class CustomIndexDashboard(Dashboard):
    """
    Custom index dashboard for corpusx.
    """
...
class CustomAppIndexDashboard(AppIndexDashboard):
    """
    Custom app index dashboard for corpusx.
    """
